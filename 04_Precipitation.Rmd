...
The [World Meteorological Organization](https://wmo.int/wmo-community/meteoterm) (WMO) defined a *water year* as "Continuous 12-month period selected in such a way that overall changes in storage are minimal so that carry-over is reduced to a minimum."  
