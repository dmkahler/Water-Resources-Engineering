...
# Use the Extreme Value Type I distribution to calculate the 5- 10- and 50-year return preriod maximum values for the 10-minute rainfall.
m <- mean(x$Rainfall)
...
Tr <- 5 # This is the return period

y <- -log(log(Tr/(Tr-1)))
x <- u + (a * y) # This gives the intensity
